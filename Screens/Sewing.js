      ...
      <NavigationContainer independent={true}>
        ...
        <View>
          <Text style={styles.par}>
            Purpose: To provide new alteration and new garment tailoring services.{'\n'}
            Content:{'\n'}
            1. Types of stitches{'\n'}
            2. Threading a sewing Machine{'\n'}
            3. Sewing buttons, hemps, zips and seams{'\n'}
        ...
        <View style={{backgroundColor: "#5E52A9", height: 50, marginTop: 40}}>
          <Text></Text>
        </View>
        </View>
      </NavigationContainer>
